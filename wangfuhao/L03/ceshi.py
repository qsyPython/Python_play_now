...
flag = True
analyze_data = 50
cityAQI_name= "/Users/Ne/Python_play_now/wangfuhao/L03/resource/cityAQI_nameCESHI.csv"
...
class Spider:
    ...
    def draw_picture2(self, file_name):
        ...
        plt.xticks(np.arange(int(len(filter_data.city))), filter_data.city, rotation=270,
                   fontproperties=self.__getChineseFont(), fontsize=8)
    ...
    def draw_picture1(self,file_name):
        '''
        有问题
        '''
        pandas_data = pd.read_csv(file_name)
