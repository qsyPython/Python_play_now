"""
Django settings for django_second_models_db project.
...
ROOT_URLCONF = 'django_second_models_db.urls'
...
WSGI_APPLICATION = 'django_second_models_db.wsgi.application'
